...
//	$rpt.= '<tr><th colspan=3>' . $site[0]->address . '</th><th colspan=3>' . (isset($site[1]))?$site[1]->address:'' . '</th></tr>';
...
$mailto = $recipients;//'pw.prayitno@gmail.com,pw.prayitno@yahoo.co.id';
$from_name = 'puji wp';
$from_mail = 'puji@padi.net.id';
$replyto = 'puji@padi.net.id';
$uid = md5(uniqid(time()));
$subject = 'Laporan Survey ' . $client;
$message = 'Laporan Survey dalam attachment';
$filename = 'laporan survey.pdf';
...
redirect(base_url() . 'index.php/survey_requests/entry_ts_survey_request/type/edit/id/' . $survey_id);
exit;
