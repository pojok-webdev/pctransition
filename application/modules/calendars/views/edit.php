...
echo form_open('hosting_packages/edit_handler/perpage/3/search/all/order/asc/orderby/name/page');
echo form_hidden('id',$url['id']);
...
echo form_label('Description','description',array('class'=>'text_float_medium'));
