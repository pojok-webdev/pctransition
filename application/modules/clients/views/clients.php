		...
		<form id="cariForm" name="cariForm" method="post" action="<?php echo base_url();?>index.php/clients/obj_handler">
        <div class="search">
                Pencarian :
        ...
        <div class="content_isi">
        	<!--form id="adminForm" name="adminForm" method="post" action=""-->
            	<div class="toolbar">
                	<a href="<?php echo base_url(); ?>index.php/clients/entry_client/type/add">
                ...
                <table class="tabel" cellspacing="0" cellpadding="2" border="0">
					...
					?>
                    	<tr>
                            ...
                            <?php
                            $aktif = ($obj->active=='1')?'ya.png':'tidak.png';
							?>
                            ...
                            <td align="center"><a href='<?php echo base_url();?>index.php/clients/entry_client/type/edit/id/<?php echo $obj->id;?>'><img src="<?php echo base_url();?>themes/<?php echo $this->setting['theme'];?>/images/edit.png" /></a></td>
                        </tr>
                        <?php
							}
						?>
