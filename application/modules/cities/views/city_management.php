		...
		<form id="cariForm" name="cariForm" method="post" action="<?php echo base_url();?>index.php/cities/city_handler">
        <div class="search">
                Pencarian :
        ...
        <div class="content_isi">
            	<div class="toolbar">
                	<a href="<?php echo base_url(); ?>index.php/cities/entry_city/type/add">
                ...
                <table class="tabel" width="100%" cellspacing="0" cellpadding="2" border="0">
                    ...
                    <tbody>
                    <?php
						foreach($objs as $city){
					?>
                    	<tr>
                        	<td align="center">
                            	<input id="cb1" type="checkbox" onclick="isChecked(this.checked);" value="<?php echo $city->id;?>" name="id[]">
                            </td>
                            <td><?php echo $city->name;?></td>
                            <td><?php echo $city->description;?></td>
                            <?php
                            $active = ($city->active=='1')?'ya.png':'tidak.png';
							?>
                            <td align="center"><img src="<?php echo base_url();?>themes/<?php echo $this->setting['theme'];?>/images/<?php echo $active;?>" /></td>
                            <td align="center"><?php echo $city->create_date;?></td>
                            <td align="center"><a href='<?php echo base_url();?>index.php/cities/entry_city/type/edit/id/<?php echo $city->id;?>'><img src="<?php echo base_url();?>themes/<?php echo $this->setting['theme'];?>/images/pensil.jpg" /></a></td>
                        </tr>
                        <?php
							}
						?>
