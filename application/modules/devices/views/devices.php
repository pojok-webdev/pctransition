    	<h1>Peralatan</h1>
		<form id="cariForm" name="cariForm" method="post" action="<?php echo base_url();?>index.php/devices/device_handler">
        ...
        <div class="content_isi">
            	<div class="toolbar">
                	<a href="<?php echo ($this->preference['c'][2]=='1')?base_url() . 'index.php/devices/entry_survey_request/type/add':'#'; ?>">
                ...
                <table class="tabel" cellspacing="0" cellpadding="2" border="0">
					...
					?>
                    	<tr>
                            ...
                            <?php 
                            $edit_url = ($this->preference['u'][2] == '1')?base_url() . 'index.php/devices/entry_survey_request/type/edit/id/' . $obj->id:'#';
                            ?>
