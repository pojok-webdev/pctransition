...
<head>
    ...
    <style type="text/css">
        ...
        #report th { background:#7CB8E2 url(/img/janko/header_bkg.png) repeat-x scroll center left; color:#fff; padding:7px 15px; text-align:left;}
        #report td { background:#C7DDEE none repeat-x scroll center left; color:#000; padding:7px 15px; }
        #report tr.odd td { background:#fff url(/img/janko/row_bkg.png) repeat-x scroll center left; cursor:pointer; }
        #report div.arrow { background:transparent url(/img/janko/arrows.png) no-repeat scroll 0px -16px; width:16px; height:16px; display:block;}
...
<body>
    <h1>Laporan Ticket <?php echo $objs->ticket->client->name?></h1>
    <p>Jl xxx Sidorame</p>
    <table id="report">
        <tr>
            <th>Country</th>
