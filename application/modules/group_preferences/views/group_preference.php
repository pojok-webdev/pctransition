    	<h1>Group Preference</h1>
		<form id="cariForm" name="cariForm" method="post" action="<?php echo base_url();?>index.php/group_preferences/group_preferences_handler">
        <div class="search">
                Pencarian :
        ...
        <div class="content_isi">
            	<div class="toolbar">
                	<a href="<?php echo base_url();?>index.php/group_preferences/entry_group/type/add">
                ...
                <table class="tabel" width="100%" cellspacing="0" cellpadding="2" border="0">
					...
					?>
                    	<tr class="tr_a">
                            ...
                            <td align="center">
                            <a href="<?php echo base_url();?>index.php/group_preferences/entry_group_preference/type/edit/id/<?php echo $tbl->id;?>">
