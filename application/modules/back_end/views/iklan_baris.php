    	<h1><?php echo $this->lang->line('advertise_management');?></h1>
        ...
        <div class="content_isi">
            	<div class="toolbar">
                	<a href="<?php echo base_url();?>index.php/back_end/entry_iklan/type/add">
                    ...
                    ?>
                    	<tr>
                            ...
                            <td><?php echo $advertise->subject;?></td>
                             <td><?php echo $advertise->content;?></td>
                             <?php 
                            ...
                            <td align="center"><a href='<?php echo base_url();?>index.php/back_end/entry_iklan/type/edit/id/<?php echo $advertise->id;?>'><img src="<?php echo base_url()?>themes/<?php echo $this->setting['theme'];?>/images/edit.png" /></a></td>
                        </tr>
                    <?php 
                    }
                    ?>
