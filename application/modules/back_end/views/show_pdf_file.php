...
echo form_open_multipart('back_end/upload_pdf_file');
...
echo '<td>' . anchor('back_end/entry_magazine/type/edit/identifier/' . $identifier . '/identifier_value/' . $identifier_value . '/image_type/pdf/image/' . $f . '/page/0',$this->lang->line('use')) . '</td>';
