    	<h1><?php echo $this->lang->line('entry_page');?></h1>
  <div class="content_isi">
        	<form id="adminForm" name="adminForm" method="post" action="<?php echo base_url()?>index.php/back_end/entry_page_handler">
        	<?php 
                        ...
                        <table width="100%" cellspacing="2" cellpadding="2" border="0">
                        	<tbody>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                    <textarea name="content" class='ckeditor' cols="40" id="content"><?php echo $content;?></textarea>
                                    </td>
                                </tr>                                
                                <tr>
