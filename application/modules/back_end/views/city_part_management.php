    	<h1>City Part Management</h1>
		<form id="cariForm" name="cariForm" method="post" action="<?php echo base_url();?>index.php/back_end/city_part_handler">
        <div class="search">
                Pencarian :
        ...
        <div class="content_isi">
        	<!--form id="adminForm" name="adminForm" method="post" action=""-->
            	<div class="toolbar">
                	<a href="<?php echo base_url(); ?>index.php/back_end/entry_city_part/type/add">
                ...
                <table class="tabel" width="100%" cellspacing="0" cellpadding="2" border="0">
					...
					?>
                    	<tr>
                            ...
                            <?php
                            $aktif = ($city->aktif=='1')?'ya.png':'tidak.png';
							?>
                            ...
                            <td align="center"><a href='<?php echo base_url();?>index.php/back_end/entry_city_part/type/edit/id/<?php echo $city->id;?>'><img src="<?php echo base_url();?>themes/<?php echo $this->setting['theme'];?>/images/edit.png" /></a></td>
                        </tr>
                        <?php
							}
						?>
