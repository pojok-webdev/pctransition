		...
		<form id="cariForm" name="cariForm" method="post" action="<?php echo base_url();?>index.php/back_end/install_request_handler">
        ...
        <div class="content_isi">
            	<div class="toolbar">
                	<a href="<?php echo ($this->preference['c'][2]=='1')?base_url() . 'index.php/back_end/entry_install_request/type/add':'#'; ?>">
                ...
                <table class="tabel" cellspacing="0" cellpadding="2" border="0">
                	<thead>
                    	<tr>
                            ...
                            <th width="11%" align="center">TGL INSTALL</th>
					...
					?>
                    	<tr>
                            ...
                            <?php 
                            $edit_url = ($this->preference['u'][2] == '1')?base_url() . 'index.php/install_requests/entry_install_request/type/edit/id/' . $obj->id:'#';
                            ?>
