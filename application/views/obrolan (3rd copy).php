...
<script type="text/javascript">
	(function($){
		...
		getmessage = function(lastid,preceiver){
			...
			if(preceiver===receiverid){
				$.ajax({
					...
					if(data.x.length>0){
						...
						console.log("produced last id "+data.x[arrlength].id);
						console.log("last receiver "+data.x[arrlength].receiverid);
				...
				//			console.log($("#userid").val() +" " +y.senderid);
							...
							if(y.senderid===$("#userid").val()){
								...
								$("#messages #mCSB_1 .mCSB_container").prepend('<div class="itemOut"><a class="image" href="#"><img class="img-polaroid" width="50" height="50" src="https://teknis/media/users/amir.jpg"></a><div class="text"><div class="info clearfix"><span class="name">'+$("#username").val()+'</span><span class="date">'+y.createdate+'</span></div>'+y.content+'</div></div></div>');
							}
							if(y.senderid!==$("#userid").val()){
								console.log("must be inserted itemin");
								$("#messages #mCSB_1 .mCSB_container").prepend('<div class="itemIn"><a class="image" href="#"><img class="img-polaroid" width="50" height="50" src="https://teknis/media/users/amir.jpg"></a><div class="text"><div class="info clearfix"><span class="name">'+y.sendername+'</span><span class="date">'+y.createdate+'</span></div>'+y.content+'</div></div></div>');
							}
				//			console.log("row ID : "+y.id);
						});
			...
			//console.log("receiver id : "+$(".chatusers .chatuser.selected").attr("userid"));
		}
