...
<body>
                ...
                <div class="span12">
                    ...
                    <div class="block-fluid">
                        <div class="row-form clearfix">
                            ...
                            <div class="span6"><input type="text" id="txtclient" value="<?php echo $obj->name;?>" title="Nama pelanggan autocomplete dengan minimal 2 huruf pertama" /></div>
                            <div class="span3"><input type="text" id="client_site_id" value="<?php echo $obj->clientsiteid;?>"/></div>
                        </div>
                        <div class="row-form clearfix">
                        ...
                        <div class="row-form clearfix" id="denterprise">
                            ...
                            <div class="span1">
                                <input type="text" id="integer_part" value="<?php echo $obj->integer_part;?>" class="tipb" title="angka depan koma (Up Speed dalam Mbps)">
                            </div>
                            <div class="span1">
                                <input type="text" id="fraction_part" value="<?php echo $obj->fraction_part;?>" class="tipb" title="angka belakang koma (Up Speed dalam Mbps)">
                            </div>
                            <div class="span2 align-right">Down (Mbps):</div>
                            <div class="span1">
                                <input type="text" id="integer_part" value="<?php echo $obj->integer_part_down;?>" class="tipb" title="angka depan koma (Down Speed dalam Mbps)">
                            </div>
                            <div class="span1">
                                <input type="text" id="fraction_part" value="<?php echo $obj->fraction_part_down;?>" class="tipb" title="angka belakang koma (Down Speed dalam Mbps)">
                            </div>
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span3">
                                    <?php echo form_dropdown("endhour",$hours,$obj->endhour,"id='endhour'");?>
                            </div>
                            <div class="span3">
                                    <?php echo form_dropdown("endminute",$minutes,$obj->endminute,"id='endminute'");?>
                            </div>
                        </div>
                    </div>
                </div>  
    ...
    <script type="text/javascript" src="/js/v2/trials/edit.js"></script>
</body>
</html>
