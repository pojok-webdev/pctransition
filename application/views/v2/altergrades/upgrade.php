...
<body>
                ...
                <div class="span12">
                    ...
                    <div class="block-fluid">
                        ...
                        <div class="row-form clearfix" id="denterprise">
                            ...
                            <div class="span1">
                                <input type="text" id="integer_part_enterprise_up" value="0" class="tipb" title="angka depan koma (Up Speed dalam Mbps)">
                            </div>
                            <div class="span1">
                                <input type="text" id="fraction_part_enterprise_up" value="0" class="tipb" title="angka belakang koma (Up Speed dalam Mbps)">
                            </div>
                            <div class="span2 align-right">Down (Mbps):</div>
                            <div class="span1">
                                <input type="text" id="integer_part_enterprise_down" value="0" class="tipb" title="angka depan koma (Down Speed dalam Mbps)">
                            </div>
                            <div class="span1">
                                <input type="text" id="fraction_part_enterprise_down" value="0" class="tipb" title="angka belakang koma (Down Speed dalam Mbps)">
                            </div>
                        ...
                        <div class="row-form clearfix" id="diix">
                            ...
                            <div class="span2">Up (Mbps):</div>
                            <div class="span1">
                                <input type="text" id="integer_part_iix_up" value="0" class="tipb" title="angka depan koma (Up Speed dalam Mbps)">
                            </div>
                            <div class="span1">
                                <input type="text" id="fraction_part_iix_up" value="0" class="tipb" title="angka belakang koma (Up Speed dalam Mbps)">
                            </div>
                            <div class="span2 align-right">Down (Mbps):</div>
                            <div class="span1">
                                <input type="text" id="integer_part_iix_down" value="0" class="tipb" title="angka depan koma (Down Speed dalam Mbps)">
                            </div>
                            <div class="span1">
                                <input type="text" id="fraction_part_iix_down" value="0" class="tipb" title="angka belakang koma (Down Speed dalam Mbps)">
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="/js/v2/altergrades/upgrade.js"></script>
</body>
</html>
