					...
					<div class="span6">
						<div class="block-fluid without-head">
							...
							<div class="row-form clearfix">
								...
								<div class="span9">
									<label name="name" id="clientname" class="inp_fb">
										<?php echo $client->name;?>
										<input type="hidden" id="clientnameori" value="<?php echo $client->name;?>" />
									</label>
								</div>
							</div>
							<div class="row-form clearfix">
							...
							<div class="row-form clearfix">
								...
								<div class="span9"><input type="text" name="address" id="clientaddress" class="inp_fb" value="<?php echo $client->address;?>"/></div>
							</div>
							<div class="row-form clearfix">
								<div class="span3">Telp</div>
								<div class="span4"><input type="text" name="telp" id="clientphone" class="inp_fb" value="<?php echo $client->phone;?>"/></div>
								<div class="span1">Fax</div>
								<div class="span4"><input type="text" name="fax" id="clientfax" class="inp_fb" value="<?php echo $client->fax;?>"/></div>
							</div>
						</div>
					</div>
					<div class="span6">
						<div class="block-fluid without-head">
							...
							<div class="row-form clearfix">
								...
								<div class="span9"><input type="text" name="siup" id="siup" class="inp_fb" value="<?php echo $client->siup;?>"/></div>
							</div>
							<div class="row-form clearfix">
								<div class="span3">NPWP</div>
								<div class="span9"><input type="text" name="npwp" id="npwp" class="inp_fb" value="<?php echo $client->npwp;?>" /></div>
							</div>
						</div>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span6">
						<div class="block-fluid without-head">
							...
							<div class="row-form clearfix">
								<div class="span3">Nama <sup class="redsup">*</sup></div>
								<div class="span9"><input type="text" name="name" id="subscribername" class="inp_subscriber" value="<?php $objs->role;?>"/>
                                </div>
							</div>
							<div class="row-form clearfix">
