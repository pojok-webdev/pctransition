...
<body>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="head clearfix">
                        ...
                        <ul class="buttons">
                            <li><a id="btnsaveclient" class="isw-save"></a>
                            </li>
                        </ul>
                    </div>
                    <div class="block-fluid">
                        <div class="row-form clearfix">
                            ...
                            <div class="span6"><input type="text" id="txtclient" /></div>
                            <div class="span3"><input type="hidden" id="client_site_id" /></div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">Periode:</div>
                            <div class="span9">
                                <?php echo form_dropdown("periods",$periods,0,"id='period_type'");?>
                            </div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">Deskripsi:</div>
                            <div class="span9">
                                <textarea id="txtdescription" class="myeditor"></textarea>
                            </div>
                        </div>
                        <div class="row-form clearfix">
    ...
    <script type="text/javascript" src="/js/v2/maintenanceschedules/addclient.js"></script>
</body>
</html>
