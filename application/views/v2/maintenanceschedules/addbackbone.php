...
<body>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="head clearfix">
                        ...
                        <ul class="buttons">
                            <li><a id="btnsavebackbone" class="isw-save"></a>
                            </li>
                        </ul>
                    </div>
                    <div class="block-fluid">
                        <div class="row-form clearfix">
                            <div class="span3">Backbone:</div>
                            <div class="span6"><input type="text" id="txtbackbone" /></div>
                            <div class="span3"><input type="hidden" id="txtidbackbone" /></div>
                        </div>
                        <div class="row-form clearfix">
    ...
    <script type="text/javascript" src="/js/v2/maintenanceschedules/addbackbone.js"></script>
</body>
</html>
