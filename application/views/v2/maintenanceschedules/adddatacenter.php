...
<body>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="head clearfix">
                        ...
                        <ul class="buttons">
                            <li><a id="btnsavedatacenter" class="isw-save"></a>
                            </li>
                        </ul>
                    </div>
                    <div class="block-fluid">
                        <div class="row-form clearfix">
                            <div class="span3">Data Center:</div>
                            <div class="span6"><input type="text" id="txtdatacenter" /></div>
                            <div class="span3"><input type="hidden" id="txtiddatacenter" /></div>
                        </div>
                        <div class="row-form clearfix">
    ...
    <script type="text/javascript" src="/js/v2/maintenanceschedules/adddatacenter.js"></script>
</body>
</html>
