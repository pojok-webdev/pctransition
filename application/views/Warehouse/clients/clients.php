                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tClient">
                            ...
                            <tbody>
                                ...
                                <tr myid='<?php echo $obj->id;?>'>
                                    ...
                                    <td>
										<div class="btn-group">
											<button data-toggle="dropdown" class="btn btn-small dropdown-toggle"  <?php echo $this->common->grantElement($obj->user->id,"decessor")?> >Aksi <span class="caret"></span></button>
											<ul class="dropdown-menu pull-right">
												<li class="btnviewsites" ><a href="#">Lihat Cabang</a></li>
											</ul>
										</div>
                                    </td>
                                </tr>
...
<script type='text/javascript' src='<?php echo base_url();?>js/aquarius/Warehouse/clients.js'></script>
</body>
</html>
