		...
		<div class="row-fluid">
			...
			<div class="span6">
				<div class="block-fluid without-head">
					...
					<div class="row-form clearfix">
						<div class="span5">Nama PIC Client / Jabatan:</div>
						<div class="span3">
					...
					<div class="row-form clearfix">
						...
						<div class="span9">
							<textarea id='confirmationresult' class='okreq myeditor'></textarea>
						</div>
					</div>
					<div class="row-form clearfix">
...
<div id="dAddTicket" class="modal hide fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
					...
					<div class="span6">
						<div class="block-fluid without-head">
							...
							<div class="row-form clearfix" id="client_site_textbox_div">
								<div class="span4">Lokasi</div>
								<div class="span8">
									<input type="text" id="location" name="location" class="inp_ticket" >
								</div>
							</div>
							<div class="row-form clearfix">
							...
							<div class="row-form clearfix">
								...
								<div class="span8"><textarea type="textarea" name="complaint" id="complaint" class="inp_ticket myeditor"></textarea></div>
							</div>
						</div>
					</div>
					<div class="span6">
						<div class="block-fluid without-head">
							<div class="row-form clearfix">
								<div class="span3">Start Request</div>
								<div class="span4">
							...
							<div class="row-form clearfix">
								<div class="span3">End Request</div>
								<div class="span4">
			...
			<div class="modal-footer">
				<button type="button"  class="btn" id="btnsaveticket">Simpan</button>
			</div>
		</div>
	</div>
</div>
