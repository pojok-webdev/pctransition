...
/*										$arr = array();
										...
										<tr thisid='<?php echo $obj->id; ?>' class="<?php echo $ticketclass . ' ' .$status;?>">
											...
											<td class="tbl_action editticket" requestid="<?php echo $obj->id; ?>">
												<div class="btn-group">
													...
													<ul class="dropdown-menu pull-right">
														...
														?>
														<li class='btntroubleshoot_ padiDisabled'>Troubleshoot</li>
														<li class='btnfollowup_ padiDisabled'>Follow Up Ticket</li>
		...
		<script type='text/javascript' src='<?php echo base_url(); ?>js/aquarius/CRO/tickets/tickets.js'></script>
