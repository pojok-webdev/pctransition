                ...
                <div class="span12">
                    ...
                    <div class="block-fluid">
                        ...
                        <div class="row-form clearfix">
							<form>
								<div class="span3">Authentication:</div>
								<div class="span3">
									<input type="text" name="username" value="puji" />
								</div>

								<div class="span3">
									<input type="password" name="password" value="pujicute2016"/>
								</div>

								<div class="span3">
									<button class="btn" type="button" onclick="doAuth(this.form)">Sign In</button>
								</div>
							</form>
                        </div>
