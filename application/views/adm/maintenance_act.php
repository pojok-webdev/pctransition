...
<?php $this->load->view('adm/head')?>
	<script type='text/javascript' src='<?php echo base_url();?>js/aquarius/maintenance_act.js'></script>
                        ...
                        <div class="span12">                        
                            <div class="block-fluid without-head clearfix">
                                <ul class="sList" id="selectable_1x">
                                    <li id="correct_surveydate">Koreksi Tanggal Survey</li>                                    
                                    <li id="approve_surveydate" class="ui-selected">Menyetujui</li>
                                </ul>
                            </div>                   

							<div class='row-form clearfix'>
							<div class="btn-group clearfix">                                        
								<button data-toggle="dropdown" class="btn dropdown-toggle">Set Status <span class="caret"></span></button>
								<ul class="dropdown-menu" id="setstatus">
									<li id='setbelumselesai' status='0'><a>Belum Selesai</a></li>
									<li id='setdalamprogress' status='1'><a>Dalam Progress</a></li>
									<li class="divider"></li>
									<li id='setselesai' status='2'><a>Sudah Selesai</a></li>
								</ul>
							</div>
							</div>
                ...
                <!-- START OF Maintenance Operator -->
                    <div class="block-fluid without-head">                        
                        <div class="toolbar nopadding-toolbar clearfix">
                            ...
                            <!-- Add popup -->
                            <div id="navMaintenanceOperator" class="popup" style="display: none;">
								...
								<?php foreach(User::get_user_by_group('TS') as $user){?>
                                    <div class="item clearfix">
                                        ...
                                        <div class="info">
                                            <a class="name petugasMaintenance" id='<?php echo $user->id;?>' survey_id='<?php echo $obj->id;?>' username='<?php echo $user->username;?>'><?php echo $user->username;?></a>
                                ...
                                <div class="footer">
                                    <button class="btn link_navPopMaintenanceOperator" type="button">Close</button>
                                </div>
                            </div>                                                                                                                          
                            <!-- End of popup -->
                        </div>                         
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table images material operator">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="info"><a class="fancybox" rel="group" href="<?php echo base_url();?>img/aquarius/example_full.jpg"><?php echo $operator->name;?></a> <span>fk-hseosqassr.jpg</span> <span>10.11.2012 10:42</span></td>
                                    <td><?php echo $operator->amount;?></td>
                                    <td><a><span class="icon-remove operator_remove" operator_id='<?php echo $operator->id;?>'></span></a></td>
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>                    
