    ...
    status = $('#status');
		new AjaxUpload(btnUpload, {
			...
			onComplete: function(file, response){
				...
				if(response==="success"){
					$('.gambar').append('<tr><td><input type="checkbox" name="checkbox"/></td><td><a class="fancybox" rel="group" href="'+baseurl+'img/aquarius/example_full.jpg"><img src="'+baseurl+'img/aquarius/example_xmini.jpg" class="img-polaroid"/></a></td><td class="info"><a class="fancybox" rel="group" href="'+baseurl+'img/aquarius/example_full.jpg">gantidaku</a> <span>fk-hseosqassr.jpg</span> <span>10.11.2012 10:42</span></td><td>gantidaku2</td><td><a href="#"><span class="icon-pencil"></span></a> <a><span onClick="removesurveysite()" class="icon-remove pointer device_remove"  site_id=1></span></a></td></tr>');
				} else{
            ...
            <div class="row-fluid">                
                <div class="span3">
                    <div class="ushort clearfix">
                        <a href="#"><?php echo $obj->id . ' - ' . $obj->survey_request->client->name;?></a>
