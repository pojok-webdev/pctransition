                                    ...
                                    <td>
										<div class="btn-group">
											...
											<ul class="dropdown-menu pull-right">
												...
												<li class="btneditpic" ><a>Edit PIC (Popup)</a></li>
												<li class="btnsetnonactive" ><a>Set Non Aktif</a></li>
...
<script type='text/javascript' src='<?php echo base_url();?>js/aquarius/adm/clients/clients.js'></script>
</body>
</html>
