...
<body>
			...
			<div class="row-fluid">
                <div class="span12">
					<div class="row-form clearfix">
						<div class="span3">Start Down</div>
						<div class="span6"><input type="text" id="ticketstart" class="datetimepickers"></div>
						<div class="span3"><a id="clearticketstart">clear</a></div>
					</div>
					<div class="row-form clearfix">
						<div class="span3">End Down</div>
						<div class="span6"><input type="text" id="ticketend" class="datetimepickers"></div>
						<div class="span3"><a id="clearticketend">clear</a></div>
					</div>
					<div class="row-form clearfix">
	...
	<!-- Start of Edit Request -->
	<div class="modal hide fade" id="dEditRequest" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" idrequest="">
	   <div class="modal-dialog">
		  <div class="modal-content">
			 <div class="modal-header">
				<button type="button" class="close" 
				...
				<div class="row-fluid">
					<div class="span6">
						<div class="block-fluid withoutt-head">
							...
							<div class="row-form clearfix">
								<div class="span4">Jenis</div>
								<div class="span8">
									<select name="requesttype" id="erequesttype" class="requesttype">
										<option value="backbone">Backbone</option>
										<option value="datacenter">Data Center</option>
										<option value="bts">BTS</option>
										<option value="pelanggan">Pelanggan</option>
							...
							<div class="row-form clearfix">
								<div class="span4">Nama</div>
								<div class="span8">
									<select name="clientname" id="eclientname" class="clientname">
									<option></option>
									</select>
								</div>
							</div>
							...
							<div class="row-form clearfix">
								...
								<div class="span8">
									...
									<select name="service" id="eservice" class="service">
										<option></option>
									</select>
							...
							<div class="row-form clearfix">
								<div class="span4">Lokasi</div>
								<div class="span8">
									<select id="elocation" name="location">
										<option></option>
									</select>
								</div>
							</div>
							...
							<div class="row-form clearfix">
								<div class="span4">Nama</div>
								<div class="span8"><input type="text" id="ename" name=="name" /></div>
							</div>

							<div class="row-form clearfix">
								<div class="span6">Penyebab</div>
								<div class="span12">
								<?php echo form_dropdown('cause',$ticketcauses,0,'id="ecause" class="cause"');?>
								</div>
							</div>
					...
					<div class="span6">
						<div class="block-fluid without-head">
							<div class="row-form clearfix">
								<div class="span4">Mulai Request</div>
								<div class="span8"><input type="text" id="erequeststart" name="requeststart" class="datetimepickers" /></div>
							</div>

							<div class="row-form clearfix">
								<div class="span4">Keluhan/Request</div>
								<div class="span8"><textarea name="content" id="econtent"></textarea></div>
							</div>

							<div class="row-form clearfix">
								
								<div class="span4"><button type="button" class="btn btn-primary" id="ebtn-ticket">Edit Ticket</button></div>
								<div class="span8"><label id="resumeticket"></label></div>
							</div>
							<div class="row-form clearfix">
								<div class="span4">Solusi</div>
								<div class="span8">
								<?php echo form_textarea('solusi','','id="esolusi" class="cause"');?>
								</div>
							</div>
			 ...
			 <div class="modal-footer">
				...
				<div class="btn-group">
					<button data-toggle="dropdown" class="btn btn-warning dropdown-toggle">Tutup dan simpan <span class="caret"></span></button>
					<ul class="dropdown-menu">
						<li><a href="#" id="erequest_selesai">Request Selesai</a></li>
						<li><a href="#" id="erequest_belum_selesai">Request Belum selesai</a></li>
					</ul>
				</div>          
				<!-- button dropdown end -->                                   
			 </div>
                            ...
                            <tbody>
								...
								<?php
									...
									if($obj->ticketstart!='0000-00-00 00:00:00'){
										$ticketend = ($obj->ticketend!='0000-00-00 00:00:00')?$obj->ticketend:$today;
									...
									$diff = Common::differenceInTimes($obj->ticketstart,$ticketend);
								?>
                                <tr>
                                    <td><?php echo $obj->clientname;?></td>
                                    <td><?php echo $ticketstart;?></td>
                                    <td><?php echo $ticketend;?></td>
                                    <td class="tbl_duration"><span class="vartime"><?php 
                                    //echo $diff->d . ' Hari ' . $diff->h . ' Jam ' . $diff->i . ' menit '; 
									echo Common::humanizetime($diff);
                                    ?></span></td>
                                    <td class="tbl_action editticket" requestid="<?php echo $obj->id;?>"><a class='icon-pencil'></a></td>                                    
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>
