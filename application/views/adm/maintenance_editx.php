				...
				<div class="block">
					<ul class="the-icons clearfix">
						<?php foreach(User::get_user_by_group('TS') as $user){?>
							<li><img src="<?php echo base_url();?>media/users/<?php echo $user->username;?>.jpg" width=32 height=32 class="img-polaroid"/><a class="petugasMaintenance" id='<?php echo $user->id;?>' survey_id='<?php echo $obj->id;?>' username='<?php echo $user->username;?>'><?php echo $user->username;?></a></li>
						<?php }?>
                ...
                <div class="span6">
                    <div class="block-fluid without-head">
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span4"><?php echo form_input('required_time1',$required_time1,'id="required_time1"');?></div>
                            <div class="span1"> s/d </div>
                            <div class="span4"><?php echo form_input('required_time2',$required_time2,'id="required_time2"');?></div>
                        </div>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table images material operator">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a><span class="icon-trash operator_remove" operator_id='<?php echo $operator->id;?>'></span></a></td>
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>                    
