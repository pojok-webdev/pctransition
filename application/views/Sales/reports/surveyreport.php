	...
	<body>
		...
		<script type="text/javascript">
			...
			orderlink = function(orderby,branch){
				...
				window.location.href = baseurl+"rpt/surveyreport/"+orderby+"/"+rorder+"/"+$("#dt1").attr("datetime")+"/"+$("#dt2").attr("datetime")+"/"+branch+"/"+amarr.join("-");
			}
				...
				$("#btnfilter").click(function(){
					...
					if(allchecked){
						window.location.href = baseurl+"rpt/surveyreport/"+urlsegment(3)+"/"+order+"/"+$("#dt1").attr("datetime")+"/"+$("#dt2").attr("datetime")+"/"+branch+"/"+amarr.join("-");
					}else{
