		...
		<div class="container">
            ...
            <div class="row bordered">
                <div class="col-xs-12">
                    ...
                    <span id="businesstype"><?php echo $fb->businesstype;?>
                    </span>
                </div>
            </div>
            <div class="row bordered">
            ...
            <div class="row">
                <div class="col-xs-12"><strong>SIUP</strong> <span id="siup"><?php echo $fb->siup;?></span></div>
            </div>
            <div class="row bordered">
                <div class="col-xs-12"><strong>NPWP</strong> <span id="npwp"><?php echo $fb->npwp;?></span></div>
            </div>
            <div class="row">
                <div class="col-xs-12">
