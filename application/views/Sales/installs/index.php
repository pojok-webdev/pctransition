	...
	<body>
		...
		<tbody>
			...
			<tr install_id='<?php echo $obj->install_request_id;?>'>
				...
				<td><span class="tohuman"><?php echo $obj->install_date;?></span></td>
				<td><?php echo $obj->address . ' - ' . $obj->city;?></td>
				<td class="updatable" fieldName="execdate">
				<span class="tohumandate"><?php echo $obj->execdate;?></span>
				<span class="tohumanhourminute"><?php echo $obj->execdate;?></span>
				</td>
				<td><?php echo $obj->pic_name . '(' . $obj->pic_phone_area . ') ' . $obj->pic_phone;?></td>
				<td>
				<div class="btn-group">
				<button data-toggle="dropdown" class="btn dropdown-toggle"  <?php echo $this->common->grantElement($obj->client_site->client->sale_id,"decessor")?>  <?php echo $disabled;?>>Action <span class="caret"></span></button>
