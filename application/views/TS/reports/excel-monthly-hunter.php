		...
		<table>
			...
			<tbody>
				<tr>
					...
					<?php echo isset($suspect[$x])?'<td>'.$suspect[$x].'</td>':"<td class='zeroval'>0</tdtd>";?>
					<?php }?>
				...
				<tr>
					...
					<?php for($x=1;$x<=$day_in_month;$x++){?>
					<?php echo isset($prospect[$x])?'<td>'.$prospect[$x].'</td>':"<td class='zeroval'>0</tdtd>";?>
					<?php }?>
					<?php switch($day_in_month){
						case 28:
				...
				<tr>
					...
					<?php switch($day_in_month){
						case 28:
							echo "<th>=SUM(B6:AC6)</th>";
						break;
						case 29:
							echo "<th>=SUM(B6:AD6)</th>";
						break;
						case 30:
							echo "<th>=SUM(B6:AE6)</th>";
						break;
						case 31:
							echo "<th>=SUM(B6:AF6)</th>";
						break;
					}?>
				</tr>
				<tr>
					...
					<?php switch($day_in_month){
						case 28:
							echo "<th>=SUM(B7:AC7)</th>";
						break;
						case 29:
							echo "<th>=SUM(B7:AD7)</th>";
						break;
						case 30:
							echo "<th>=SUM(B7:AE7)</th>";
						break;
						case 31:
							echo "<th>=SUM(B7:AF7)</th>";
						break;
					}?>
				</tr>
				...
				<tr>
					...
					<?php switch($day_in_month){
						case 28:
							echo "<th>=SUM(AD3:AD7)</th>";
						break;
						case 29:
							echo "<th>=SUM(AE3:AE7)</th>";
						break;
						case 30:
							echo "<th>=SUM(AF3:AF7)</th>";
						break;
						case 31:
							echo "<th>=SUM(AG3:AG7)</th>";
						break;
					}?>
				</tr>
