<html>
	<head>
		...
		<title>Laporan Tiket Yang Masih Open </title>
	</head>
	<body>
		<div class="container">
		<div class="jumbotron">
		<h3>Laporan Tiket Yang Masih Open </h3>
		<h5>
			...
			<table id="rpt" class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $this->common->sql_to_human_datetime($suspect->ticketstart);?></td>
		...
		<script type="text/javascript">
			...
			orderlink = function(orderby,branch){
				...
				window.location.href = baseurl+"rpt/showOpenTicket/"+orderby+"/"+rorder+"/"+branch+"/"+range+"/"+$("#startdate").attr("datetime")+"/"+$("#enddate").attr("datetime");
			}
			$("#btnfilter").click(function(){
				...
				$(".optage").click(function(){
					...
					window.location.href = baseurl+"rpt/showOpenTicket/"+urlsegment(3)+"/"+order+"/"+branch+"/"+$(this).attr("value")+"/"+$("#startdate").attr("datetime")+"/"+$("#enddate").attr("datetime");
				});
