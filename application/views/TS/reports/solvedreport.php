<html>
	...
	<body>
		<div class="container">
		<div class="jumbotron">
		<h3>Laporan Tiket Yang Sudah Terselesaikan</h3>
		<h5>
				...
				<div class="well col-sm-12">
					<div class="col-sm-3">
						...
						<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
						  <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="optage" value="1">&le;1 hari</a></li>
						  <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="optage" value="2">&le;3 hari</a></li>
						  <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="optage" value="3">&le; 7 hari</a></li>
		...
		<div class="row">
			<table id="rpt" class="table">
				<thead>
					<tr>
						<th>No</th>
						<th onClick='orderlink("ticketstart","1")' class="pointer">Start</th>
						<th onClick='orderlink("ticketend","1")' class="pointer">End</th>
		...
		<script type="text/javascript">
			...
			orderlink = function(orderby,branch){
				...
				$("#startdate").getdate();
				$("#enddate").getdate();
				window.location.href = baseurl+"rpt/solvedreport/"+orderby+"/"+rorder+"/"+branch+"/"+range+"/"+$("#startdate").attr("datetime")+"/"+$("#enddate").attr("datetime");;
			}
