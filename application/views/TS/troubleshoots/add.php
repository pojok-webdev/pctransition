...
<body>
                ...
                <div class="span6">
                    <div class="block-fluid without-head">
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span9">
								<input type="text" id="phone" name="phone" class="troubleshoot" value="<?php echo $obj->client_site->client->phone;?>"/>
                            </div>
                        </div>
                        <div class="row-form clearfix">
    ...
    <script src='<?php echo base_url();?>js/padilibs/padi.dateTime.js'></script>
    <script src='<?php echo base_url();?>js/aquarius/TS/troubleshoots/troubleshoot_add.js'></script>
</body>
</html>
