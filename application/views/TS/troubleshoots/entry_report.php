...
<body>
				...
				<div class="span6">
                    ...
                    <div class="block-fluid without-head">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table images tBA" id="ba">
                            ...
                            <tbody>
								<?php foreach($bas['result'] as $ba){?>
                                <tr myid=<?php echo $ba->id;?>>
                                    <td>
										<a class="fancybox" rel="group" href="<?php echo base_url();?>troubleshoots/bapreview/<?php echo $ba->id;?>">
											<img src="<?php echo $ba->img;?>" class="img-polaroid baimg" width=50 height=38 />
										</a>
									</td>
                                    <td class="baname"><?php echo $this->common->sql_to_human_datetime($ba->createdate);?></td>
                        ...
                        <div class="toolbar bottom-toolbar clearfix">
                            ...
                            <div class="right">
								Total : <span id="total_ba"><?php echo $bas['num_rows'];?></span>
                            </div>
                        </div>
                    </div>
				...
				<div class="span6">
					...
					<div class="block-fluid without-head">
						...
						<div class="toolbar bottom-toolbar clearfix">
							...
							<div class="right">
								Total : <span id="total_image"><?php echo $images["num_rows"];?></span>
							</div>
						</div>
					</div>
					<div class="block-fluid without-head">
						...
						<table cellpadding="0" cellspacing="0" width="100%" class="table officer" id="tOfficer">
							...
							<tbody>
								<?php foreach($officers["result"] as $image){?>
								<tr class="rImage" officer_id='<?php echo $image->id;?>' >
									...
									<td class="info image_name"><a><?php echo $image->name;?></a><span><?php echo $image->createdate;?></span></td>
									<td>
						...
						<div class="toolbar bottom-toolbar clearfix">
							...
							<div class="right">
								Total : <span id="total_officer"><?php echo $officers["num_rows"];?></span>
							</div>
						</div>
					</div>
				...
				<div class="block-fluid without-head">
                    ...
                    <div class="block-fluid without-head">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table tbl_usedmaterial" id="tbl_usedmaterial">
                            ...
                            <tbody>
								<?php foreach($tmaterials["result"] as $material){?>
                        ...
                        <div class="toolbar bottom-toolbar clearfix">
                            ...
                            <div class="right">
								Total : <span id='total_material'><?php echo $tmaterials["num_rows"];?></span>
                            </div>
                        </div>
                    </div>
	...
	<script type='text/javascript' src='<?php echo base_url();?>js/aquarius/TS/troubleshoots/ba.js'></script>
