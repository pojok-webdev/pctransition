		...
		<div class="row-fluid">
			...
			<div class="span6">
				<div class="block-fluid without-head">
					...
					<div class="footer">
						<button class="btn dclosemodal" type="button" id='saveba'>Simpan</button>
						<button class="btn dclosemodal" type="button" id='updateba'>Update</button>
						<button class="btn dclosemodal" type="button">Tutup</button>
					</div>
				</div>
			</div>
		</div>
