...
<script type='text/javascript' src='<?php echo base_url();?>js/jquery-1.8.2.min.js'></script>
	...
	<script>troubleshootid=<?php echo $troubleshootid;?></script>
</head>
...
<div class="container" id="fromHTMLtestdiv">
	...
	<div class="row padbot5">
		<div class="col-md-2 orgtext">Nama Calon Customer</div><div class="col-md-10" id="customername">&nbsp;
			<?php echo $objs->client_site->client->name;?>
		</div>
	</div>
	<div class="row padbot5">
...
<script type='text/javascript' src='<?php echo base_url();?>js/aquarius/TS/troubleshoots/report.1.js'></script>
</html>
