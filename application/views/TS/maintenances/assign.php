            ...
            <div class="row-fluid">
                <div class="span6">
                    <div class="block-fluid without-head">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table images tOperator" id="tOperator">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr myid="<?php echo $operator->id;?>">
                                    ...
                                    <td class="info">
										<a class="fancybox" rel="group" href="<?php echo base_url();?>media/users/<?php echo strtolower($operator->name);?>.jpg"><?php echo strtolower($operator->name);?>
										</a>
                                    </td>
