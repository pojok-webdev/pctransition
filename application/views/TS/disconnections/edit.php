            ...
            <div class="row-fluid">
                <div class="span6">
                    <div class="head clearfix">
                        ...
                        <h1>Edit Pelanggan <?php echo $obj->client->name;?></h1>
                    </div>
                    <div class="block-fluid">
                        <div class="row-form clearfix">
                            <div class="span4">Jadwal Pemutusan:</div>
                            <div class="span8">
								<?php echo $obj->executiondate;?>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="span6">
                    ...
                    <div class="block-fluid">
                        <div class="row-form clearfix" id="makepermanentdiv">
							<span class="icon-ok" id="executed-icon"></span>
							<button class="btn" id="executed" data-toggle="button">Sudah dieksekusi</button>
                        </div>
                    </div>
                </div>
			</div>
