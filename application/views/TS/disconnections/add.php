...
<?php $this->load->view('adm/menu');?>
    <div class="content">
		...
		<div class="row-fluid"><div class="span12"><div class="head clearfix">
			<div class="right">
				<ul class="buttons">
					<li><span class="isw-save" id="btnsavex" title="simpan"></span></li>
				</ul>
				<div class="btn-group">
					<button class="btn install_save">Simpan</button>
				</div>
            </div>
		</div>
		</div>
            ...
            <div class="row-fluid">
                <div class="span6">
                    ...
                    <div class="block-fluid">
                        ...
                        <div class="row-form clearfix">
                            <div class="span4">Tanggal eksekusi:</div>
                            <div class="span4">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tblOperator">
                            ...
                            <tbody>
                                ...
                                <tr rowid='<?php echo $operator->id;?>'>
                                    ...
                                    <td>
										<a>
											<span class="icon-trash row_remove remove_operator pointer" operator_id="<?php echo $operator->id; ?>" >
											</span>
										</a>
									</td>
                                </tr>
