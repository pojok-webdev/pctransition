...
$(document).ready(function(){
	...
	$("#btnadddps").click(function(){
		$.post(thisdomain+'adm/incomeadd',{date:changeformat($("#tanggal").val()),description:$("#uraian").val(),source:$("#student").val(),account:'1105',contraaccount:$("#contraaccount").val(),amount:$("#saving").val(),source_id:13})
		$.post(thisdomain+'adm/incomeadd',{date:changeformat($("#tanggal").val()),description:$("#uraian").val(),source:$("#student").val(),account:$("#account").val(),contraaccount:$("#contraaccount").val(),amount:$("#amount").val(),source_id:13}).fail(function(){
