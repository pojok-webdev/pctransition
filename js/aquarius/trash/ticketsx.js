$(document).ready(function() {
	...
	$("#clearticketstart").click(function(){
		$("#ticketstart").val("");
		$("#timetotal").html("");
		$("#resumeticket").html("");
	});
	
	$("#clearticketend").click(function(){
		$("#ticketend").val("");
	});
	...
	$("#erequest_selesai").click(function(){
		...
		$.post(thisdomain+"adm/requestupdate",{id:$("#dEditRequest").attr("idrequest"),requesttype:$("#erequesttype").val(),clientname:$("#eclientname :selected").text(),service:$("#eservice").val(),location:$("#elocation :selected").text(),cause:$("#ecause :selected").text(),content:$("#econtent").val(),ticketstart:changeformat($("#ticketstart").val()),ticketend:changeformat($("#ticketend").val()),requeststart:changeformat($("#erequeststart").val())}).done(function(data){
			alert(data);
//			$(".tickettable").dataTable().fnAddData([$("#clientname :selected").text(),$("#ticketstart").val(),$("#ticketend").val(),"","<td class='tbl_action editticket'><a class='icon-pencil'></a></td>"]);
			}).fail(function(){
				alert("Update Ticket tidak berhasil, silakan hubungi Developer. This domain : "+thisdomain);
