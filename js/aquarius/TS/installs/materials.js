(function($){
	...
	$('.saveusedmaterial').click(function(){
		$.post(thisdomain+'install_materials/add',{install_site_id:$('#workplace').attr('install_site_id'),material_id:$('#usedmaterial :selected').val(),tipe:$('#materialtype :selected').text(),name:$('#usedmaterial :selected').text(),description:$('#usedmaterialdescription').val(),createuser:''}).done(function(data){
